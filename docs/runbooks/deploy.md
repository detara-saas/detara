...
- imagens API/Web construídas pelo commit aprovado e publicadas com tag imutável ou digest.
...
8. Suba `api`, `web` e `reverse-proxy`.
9. Valide `https://HOST/health/live`, `https://HOST/health/ready`, login tenant, login Platform com MFA e envio de convite.
...
4. Baixe imagens: `docker compose ... pull api web`.
...
6. Recrie API/Web: `docker compose ... up -d --no-deps api web`.
