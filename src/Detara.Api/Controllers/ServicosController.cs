...
public sealed class ServicosController(ISender sender) : ControllerBase
{
    ...
    private static ServicoDetalheResponse MapearDetalhe(ServicoDetalheResultado x) => new(x.Id, x.CategoriaServicoId, x.CategoriaNome, x.Nome, x.Descricao, MapearTipo(x.TipoPrecificacao), x.PrecoBase, x.DuracaoEstimadaMinutos, x.Ordem, x.CriadoEmUtc, x.AtualizadoEmUtc, x.EhAtivo);
