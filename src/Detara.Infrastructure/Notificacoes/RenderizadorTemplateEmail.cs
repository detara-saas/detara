...
internal sealed partial class RenderizadorTemplateEmail : IRenderizadorTemplateEmail
{
    ...
    private static string MontarShell(string corpo, string empresaNome) => $"""
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f5f6f8"><tr><td align="center" style="padding:28px 12px"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #e3e7ee;border-radius:16px"><tr><td style="padding:28px"><div style="margin-bottom:22px"><!--detara-company-logo--><div style="font-size:20px;font-weight:700;color:#172033">{empresaNome}</div></div><div style="font-size:16px;line-height:1.65">{corpo}</div><div style="border-top:1px solid #e3e7ee;margin-top:26px;padding-top:16px;color:#657086;font-size:12px">Enviado via Detara.</div></td></tr></table></td></tr></table></body></html>
        """;
